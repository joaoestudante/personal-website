...
>
  <img
    ...
    alt={collectionTitle}
    class="w-full h-48 object-cover rounded-t-lg shadow"
  />
  <div class="p-6">
    <h4
    ...
    <p
      class="mt-4 font-normal text-gray-500 dark:text-gray-300 text-lg lg:text-xl"
    >
