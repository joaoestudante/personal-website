...
description: This post describes why I'm venturing into building a new Splatoon tool, and how it can be helpful for the playerbase.
image: 
  url: ""
  alt: ""
tags:
...
One of the key mechanics of the game, ever since the first release, is **gear**. Players can choose to equip their characters with different head gear (like glasses, hats, masks), clothing gear (shirts, jackets, armor) and shoes (sandals, crocs, boots, slippers). This changes their look, and perhaps most importantly, affects the **gameplay**.

Each gear piece can have up to 4 **abilities**. There are a total of 24 abilities, and they vary a lot: you can increase your damage, increase your run speed, decrease the time you take to return to the game after you die, improve your weapon's special ability recharge rate... The possibilities are not endless, but there's something for everyone.

You unlock random abilities on your gear by playing games while wearing it. It's possible to customize the abilities of your gear, so that you can have your favourite look AND abilities. But this takes **chunks**, a resource that is not easy to come by unless you play a lot or get lucky in the vending machine. You can use **drink tickets**, which increase your chances of getting a particular ability, but it will never be 100%. The Splatoon community, however, figured out that each gear piece has a **seed**. If you manage to find a piece's seed, you can easily predict the steps you'll have to take to get a particular combination of abilities.
...
The seed finder is honestly a bit complicated to use. It's necessary to read a big tutorial on it, and Leanny's interface is not super noob friendly. There's a "Gear Seed Checker", and a "Gear Seed Recovery". What's the difference? Which mode should I use? Why are there many seeds returned, when only a single one is accurate? Some gear can also be considered "fresh" if it has never been used, and this affects the seed finding process; but when searching for a seed, it's not obvious if I have a fresh gear piece or not - and so on.

I want an interface where you choose a piece of gear, you state if it's fresh or not, and you either immediately have a seed, or receive instructions on what to do to eventually have the seed. The seed should also be associated to the gear once found, and persist this on subsequent refreshes/imports.
...
I'm super excited to start this journey. I have a great tendency to leave projects unfinished, but I really want this to be different. If nothing else, at least to prove myself that I can actually ship something for once!

It's likely that things won't go exactly as I have planned. I might have to rethink the architecture, features, or decisions. All of this is ok. Accept the unpredictable and learn: that's what I'm here to do.